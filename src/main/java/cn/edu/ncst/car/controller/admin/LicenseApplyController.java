...
public class LicenseApplyController {
    ...
    public CommonResult<CommonPage> getAllLicenseApply(int pageNum,int pageSize){
    ...
    public CommonResult<CommonPage> selectLicenseByStatus(int pageNum,int pageSize,int status){
    ...
    public CommonResult<CommonPage> selectLicenseByPlateNo(int pageNum,int pageSize,String plateNo){
    ...
    public CommonResult<CommonPage> selectPersonLicense(int pageNum,int pageSize){
    ...
    public CommonResult<CommonPage> selectCompanyLicense(int pageNum,int pageSize){
    ...
    public Map<String,Object> selectOneApplyLicense(@PathVariable Integer id){
